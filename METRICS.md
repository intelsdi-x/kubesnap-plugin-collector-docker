...
a) **docker container specification info**
...
The prefix of metric's namespace is `/intel/docker/<docker_id>/cgroups/`

(e.g. /intel/docker/12345/cgroups/memory_stats/cache)
